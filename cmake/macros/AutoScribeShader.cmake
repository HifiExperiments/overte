...
macro(AUTOSCRIBE_APPEND_QRC)
    string(CONCAT SHADER_${ARGV2}_QRC "${SHADER_${ARGV2}_QRC}" "<file alias=\"${ARGV0}\">${ARGV1}</file>\n")
endmacro()

macro(AUTOSCRIBE_PLATFORM_SHADER)
    set(AUTOSCRIBE_PLATFORM_PATH "${ARGV0}")
    set(AUTOSCRIBE_PLATFORM_VARIANT "${ARGV0}")
    string(REPLACE "/" "_" AUTOSCRIBE_PLATFORM_VARIANT "${AUTOSCRIBE_PLATFORM_VARIANT}")
    ...
    AUTOSCRIBE_APPEND_QRC("${SHADER_COUNT}/${AUTOSCRIBE_PLATFORM_PATH}/scribe" "${AUTOSCRIBE_OUTPUT_FILE}" "${AUTOSCRIBE_PLATFORM_VARIANT}")
    ...
    #AUTOSCRIBE_APPEND_QRC("${SHADER_COUNT}/${AUTOSCRIBE_PLATFORM_PATH}/spirv_unopt" "${AUTOSCRIBE_SPIRV_FILE}" "${AUTOSCRIBE_PLATFORM_VARIANT}")
    ...
    AUTOSCRIBE_APPEND_QRC("${SHADER_COUNT}/${AUTOSCRIBE_PLATFORM_PATH}/spirv" "${AUTOSCRIBE_SPIRV_OPT_FILE}" "${AUTOSCRIBE_PLATFORM_VARIANT}")
    ...
    AUTOSCRIBE_APPEND_QRC("${SHADER_COUNT}/${AUTOSCRIBE_PLATFORM_PATH}/glsl" "${AUTOSCRIBE_SPIRV_GLSL_FILE}" "${AUTOSCRIBE_PLATFORM_VARIANT}")
    ...
    AUTOSCRIBE_APPEND_QRC("${SHADER_COUNT}/${AUTOSCRIBE_PLATFORM_PATH}/json" "${AUTOSCRIBE_SPIRV_JSON_FILE}" "${AUTOSCRIBE_PLATFORM_VARIANT}")
...
macro(AUTOSCRIBE_SHADER)
    ...
    AUTOSCRIBE_APPEND_QRC("${SHADER_COUNT}/name" "${SHADER_NAME_FILE}" "NAMES")
...
macro(AUTOSCRIBE_SHADER_LIBS)
    ...
    set(SHADER_VARIANTS "450" "410" "310es")
    foreach(SHADER_VARIANT IN LISTS SHADER_VARIANTS)
        configure_file(shaders${SHADER_VARIANT}.qrc.in ${CMAKE_CURRENT_BINARY_DIR}/shaders${SHADER_VARIANT}.qrc)
        list(APPEND QT_RESOURCES_FILE ${CMAKE_CURRENT_BINARY_DIR}/shaders${SHADER_VARIANT}.qrc)

        configure_file(shaders${SHADER_VARIANT}.qrc.in ${CMAKE_CURRENT_BINARY_DIR}/shaders${SHADER_VARIANT}_stereo.qrc)
        list(APPEND QT_RESOURCES_FILE ${CMAKE_CURRENT_BINARY_DIR}/shaders${SHADER_VARIANT}_stereo.qrc)
    endforeach()

    configure_file(shaderNames.qrc.in ${CMAKE_CURRENT_BINARY_DIR}/shaderNames.qrc)
    list(APPEND QT_RESOURCES_FILE ${CMAKE_CURRENT_BINARY_DIR}/shaderNames.qrc)
