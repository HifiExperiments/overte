...
SelectionDisplay = (function() {
    ...
    that.updateHandles = function() {
        ...
        if (SelectionManager.hasSelection()) {
            ...
            if (SelectionManager.entityType === "ParticleEffect" || SelectionManager.entityType === "ProceduralParticleEffect" ||
                SelectionManager.entityType === "Light" || SelectionManager.entityType === "Sound") {
